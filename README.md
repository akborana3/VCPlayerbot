...
![GitHub Repo stars](https://img.shields.io/github/stars/akborana3/VCPlayerBot?color=blue&style=flat)
![GitHub issues](https://img.shields.io/github/issues/akborana3/VCPlayerBot)
![GitHub pull requests](https://img.shields.io/github/issues-pr/akborana3/VCPlayerBot)
![GitHub contributors](https://img.shields.io/github/contributors/akborana3/VCPlayerBot?style=flat)
![GitHub forks](https://img.shields.io/github/forks/akborana3/VCPlayerBot?style=flat)
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Akborana3/VCPlayerBot)

## Deploy to Railway
<p><a href=https://github.com/akborana3/VCPlayerBot/issues/7> <img src="https://img.shields.io/badge/Deploy%20To%20Railway-blueviolet?style=for-the-badge&logo=railway" width="200""/></a></p>

 
## Deploy to VPS

```sh
git clone https://github.com/akborana3/VCPlayerBot
cd VCPlayerBot
...
[Note To A So Called Dev](https://telegram.dog/akborana/111): 

Kanging this codes and and editing a few lines and releasing a V.x  or an [alpha](https://telegram.dog/akborana/111), beta , gama branches of your repo wont make you a Developer.
...
# OWNER 
- [AKAY](https://telegram.dog/akborana1)
[![Deploy](https://telegra.ph/file/c4eb6a06a605fcfe06f4e.jpg)](https://heroku.com/deploy?template=https://github.com/Akborana3/VCPlayerBot)
