...
buttons = [
    [
        InlineKeyboardButton('⚡️Make Own Bot', url='https://github.com/akborana3/VCPlayerBot'),
...
async def search(client, query):
    ...
    if query.query == "ETHO_ORUTHAN_PM_VANNU":
        answers.append(
            InlineQueryResultArticle(
                title="Deploy",
                input_message_content=InputTextMessageContent(f"{Config.REPLY_MESSAGE}\n\n<b>You can't use this bot in your group, for that you have to make your own bot from the [SOURCE CODE](https://github.com/akborana3/VCPlayerBot) below.</b>", disable_web_page_preview=True),
